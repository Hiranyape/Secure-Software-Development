...
export const Header = () => {
   ...
   return (
      <nav className="navbar navbar-expand-sm navbar-light border-bottom" style={{ backgroundColor: '#000000'}}>
        <div className="container-fluid">
          <a href="#"><Link className="navbar-brand text-white" to="/">Fashion store</Link></a>
